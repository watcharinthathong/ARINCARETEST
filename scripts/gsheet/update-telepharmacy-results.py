...
EXCEL = os.path.join(BASE, "docs", "test-cases", "Arincare_Telepharmacy_TestCases.xlsx")

JSON_FILES = [
    os.path.join(BASE, "results", "test-results-login-final.json"),
    os.path.join(BASE, "results", "test-results-home.json"),
    os.path.join(BASE, "results", "test-results-queue.json"),
    os.path.join(BASE, "results", "test-results-chat.json"),
    os.path.join(BASE, "results", "test-results-call.json"),
]
